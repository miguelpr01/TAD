...
<section class="section-lista-proteinas" id="proteinas">
    <div class="container">
        <h1 class="text-center mb-5">Ropas</h1>
        @if (session('mensaje'))
        ...
        <div class="row">
            @foreach ($ropas as $ropa)
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="{{ $productos[$ropa->producto_id]->imagen }}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">{{ $productos[$ropa->producto_id]->nombre }}</h5>
                            <p class="card-text">{{ $productos[$ropa->producto_id]->precio }}</p>
